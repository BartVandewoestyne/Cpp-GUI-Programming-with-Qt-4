...
/**
 * The flipHorizontally() slot creates a "flip" transaction and registers it using the private
...
/**
 * The addTransaction() function adds a transaction to the secondary thread's transaction queue
 * and disables the 'Open', 'Save', and 'Save As' actions while transactions are being processed.
 */
...
/**
 * The allTransactionsDone() slot is called when the TransactionsThread's transaction queue becomes empty.
 */
